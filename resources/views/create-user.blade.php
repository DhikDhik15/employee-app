...
<body class="bg-light">
    ...
    <div class="container-md my-5">
        <div class="col-xxl-5 col-xl-6 col-lg-8 mx-auto">
            <h1 class="h1 fw-bold mb-3">Tambah Karyawan</h1>
            ...
            <form class="dropzone overflow-visible p-0" id="formDropzone" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group mb-3">
                    <label class="form-label text-muted opacity-75 fw-medium" for="joinDate">Tanggal Bergabung</label>
                    <input class="form-control border-2 shadow-none fw-bold p-3" id="joinDate" name="join_date"
                        type="date" required>
                    <div class="invalid-feedback fw-bold">The date field is required.</div>
                </div>
                <div class="form-group mb-3">
                    <label for="kode_karyawan" class="form-label text-muted opacity-75 fw-medium">Posisi</label>
                    <select class="form-control select2 border-2 shadow-none fw-bold p-3" id="position"
                ...
                <div class="form-group mb-3">
                    <label for="status_karyawan" class="form-label text-muted opacity-75 fw-medium">Status
                        Karyawan</label>
                    <select class="form-control select2 border-2 shadow-none fw-bold p-3" id="emp_status"
                        name="emp_status" required>
                ...
                <a href="{{ route('index') }}" class="btn btn-primary fw-medium py-3 px-4 mt-3">
                    Kembali
                </a>
